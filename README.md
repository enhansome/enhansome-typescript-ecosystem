...
* [TypeScript wiki](https://github.com/Microsoft/TypeScript/wiki) ⭐ 110,204 | 🐛 5,054 | 🌐 TypeScript | 📅 2026-08-14 - The official wiki for TypeScript lang
* [typescript-book](https://github.com/basarat/typescript-book/) ⭐ 21,549 | 🐛 150 | 🌐 TypeScript | 📅 2024-06-29 - 📚 The definitive guide to TypeScript and possibly the best TypeScript book 📖
...
Read [how to write your own langauge service plugin here](https://github.com/Microsoft/TypeScript/wiki/Writing-a-Language-Service-Plugin) ⭐ 110,204 | 🐛 5,054 | 🌐 TypeScript | 📅 2026-08-14.
...
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,352 | 🐛 3 | 🌐 Rust | 📅 2026-08-19 - Finds dead code, duplication, circular dependencies, and complexity hotspots in TypeScript codebases
...
* [ts-json-schema-generator](https://github.com/vega/ts-json-schema-generator) ⭐ 1,713 | 🐛 129 | 🌐 TypeScript | 📅 2026-08-09 - Generate JSON schema from your TypeScript sources
