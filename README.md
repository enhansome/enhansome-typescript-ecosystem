...
* [TypeScript wiki](https://github.com/Microsoft/TypeScript/wiki) ⭐ 110,162 | 🐛 5,082 | 🌐 TypeScript | 📅 2026-08-13 - The official wiki for TypeScript lang
...
* [@ts-tools/robotrix](https://github.com/AviVahl/ts-tools/tree/master/packages/robotrix) ⭐ 171 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-11 - Useful TypeScript transpilation transformers.
...
* [ts-transform-css-modules](https://github.com/longlho/ts-transform-css-modules) ⭐ 87 | 🐛 25 | 🌐 TypeScript | 📅 2023-01-16 - Extract css class names from required css module files for TypeScript
...
Read [how to write your own langauge service plugin here](https://github.com/Microsoft/TypeScript/wiki/Writing-a-Language-Service-Plugin) ⭐ 110,162 | 🐛 5,082 | 🌐 TypeScript | 📅 2026-08-13.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 759 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-11 - TypeScript Language Service Plugin for GraphQL developers
...
* [ts-sql-plugin](https://github.com/xialvjun/ts-sql-plugin) ⭐ 193 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-06 -  TypeScript Language Service Plugin for SQL with a tagged template strings SQL builder
...
* [ts-migrating](https://github.com/ycmjason/ts-migrating/) ⭐ 70 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-24 - an TypeScript LSP plugin that lets you migrate TSconfig

## Tools

* [ts-morph](https://github.com/dsherret/ts-morph) ⭐ 6,153 | 🐛 291 | 🌐 TypeScript | 📅 2026-07-31 -  TypeScript Compiler API wrapper for static analysis and programmatic code changes
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,321 | 🐛 14 | 🌐 Rust | 📅 2026-08-13 - Finds dead code, duplication, circular dependencies, and complexity hotspots in TypeScript codebases
