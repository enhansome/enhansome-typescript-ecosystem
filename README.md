...
* [TypeScript wiki](https://github.com/Microsoft/TypeScript/wiki) ⭐ 110,851 | 🐛 5,153 | 🌐 Go | 📅 2026-09-02 - The official wiki for TypeScript lang
...
* [@ts-tools/robotrix](https://github.com/AviVahl/ts-tools/tree/master/packages/robotrix) ⭐ 170 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - Useful TypeScript transpilation transformers.
...
* [ts-import-plugin](https://github.com/Brooooooklyn/ts-import-plugin) ⭐ 603 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-28 - Modular import plugin for TypeScript
...
Read [how to write your own langauge service plugin here](https://github.com/Microsoft/TypeScript/wiki/Writing-a-Language-Service-Plugin) ⭐ 110,851 | 🐛 5,153 | 🌐 Go | 📅 2026-09-02.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 758 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript Language Service Plugin for GraphQL developers
...
* [ts-sql-plugin](https://github.com/xialvjun/ts-sql-plugin) ⭐ 194 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-06 -  TypeScript Language Service Plugin for SQL with a tagged template strings SQL builder
...
* [ts-morph](https://github.com/dsherret/ts-morph) ⭐ 6,170 | 🐛 292 | 🌐 TypeScript | 📅 2026-08-26 -  TypeScript Compiler API wrapper for static analysis and programmatic code changes
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,440 | 🐛 6 | 🌐 Rust | 📅 2026-09-02 - Finds dead code, duplication, circular dependencies, and complexity hotspots in TypeScript codebases
...
* [ts-json-schema-generator](https://github.com/vega/ts-json-schema-generator) ⭐ 1,715 | 🐛 130 | 🌐 TypeScript | 📅 2026-08-09 - Generate JSON schema from your TypeScript sources
