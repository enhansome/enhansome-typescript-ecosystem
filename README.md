...
* [TypeScript wiki](https://github.com/Microsoft/TypeScript/wiki) ⭐ 110,986 | 🐛 5,062 | 🌐 Go | 📅 2026-09-05 - The official wiki for TypeScript lang
...
* [ts-import-plugin](https://github.com/Brooooooklyn/ts-import-plugin) ⭐ 602 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-07 - Modular import plugin for TypeScript
...
Read [how to write your own langauge service plugin here](https://github.com/Microsoft/TypeScript/wiki/Writing-a-Language-Service-Plugin) ⭐ 110,986 | 🐛 5,062 | 🌐 Go | 📅 2026-09-05.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 758 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-08 - TypeScript Language Service Plugin for GraphQL developers
...
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,462 | 🐛 3 | 🌐 Rust | 📅 2026-09-08 - Finds dead code, duplication, circular dependencies, and complexity hotspots in TypeScript codebases
