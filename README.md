...
* [TypeScript wiki](https://github.com/Microsoft/TypeScript/wiki) ⭐ 111,054 | 🐛 5,071 | 🌐 Go | 📅 2026-09-15 - The official wiki for TypeScript lang
* [typescript-book](https://github.com/basarat/typescript-book/) ⭐ 21,554 | 🐛 150 | 🌐 TypeScript | 📅 2024-06-29 - 📚 The definitive guide to TypeScript and possibly the best TypeScript book 📖
* [The Concise TypeScript Book](https://github.com/gibbok/typescript-book) ⭐ 10,344 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-14 - A free and open-source TypeScript book covering fundamentals through advanced concepts.
...
* [@ts-tools/robotrix](https://github.com/AviVahl/ts-tools/tree/master/packages/robotrix) ⭐ 171 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-12 - Useful TypeScript transpilation transformers.
...
* [ts-import-plugin](https://github.com/Brooooooklyn/ts-import-plugin) ⭐ 602 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-15 - Modular import plugin for TypeScript
...
Read [how to write your own langauge service plugin here](https://github.com/Microsoft/TypeScript/wiki/Writing-a-Language-Service-Plugin) ⭐ 111,054 | 🐛 5,071 | 🌐 Go | 📅 2026-09-15.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 758 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-14 - TypeScript Language Service Plugin for GraphQL developers
...
* [ts-morph](https://github.com/dsherret/ts-morph) ⭐ 6,180 | 🐛 292 | 🌐 TypeScript | 📅 2026-09-09 -  TypeScript Compiler API wrapper for static analysis and programmatic code changes
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,507 | 🐛 36 | 🌐 Rust | 📅 2026-09-15 - Finds dead code, duplication, circular dependencies, and complexity hotspots in TypeScript codebases
* [typescript-json-schema](https://github.com/YousefED/typescript-json-schema) ⭐ 3,266 | 🐛 188 | 🌐 TypeScript | 📅 2026-07-14 - Generate json-schema from your TypeScript sources
* [ts-json-schema-generator](https://github.com/vega/ts-json-schema-generator) ⭐ 1,715 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-02 - Generate JSON schema from your TypeScript sources
